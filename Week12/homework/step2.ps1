...
Get-ChildItem -recurse -Include *.pdf,*.xlsx,*.docx -Path .\Week12\homework | export-csv `
-Path files.csv
...
{
    Invoke-AESEncryption -Mode Encrypt -Key "nordvpn.com/internethistorian" -Path $f.FullName
}
